...
ft02_jaminandelete.Lists["x_nasabah_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Customer","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_nasabah"};
...
<?php if ($t02_jaminan->MerkType->Visible) { // MerkType ?>
		<th><span id="elh_t02_jaminan_MerkType" class="t02_jaminan_MerkType"><?php echo $t02_jaminan->MerkType->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t02_jaminan->NoRangka->Visible) { // NoRangka ?>
		<th><span id="elh_t02_jaminan_NoRangka" class="t02_jaminan_NoRangka"><?php echo $t02_jaminan->NoRangka->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t02_jaminan->NoMesin->Visible) { // NoMesin ?>
		<th><span id="elh_t02_jaminan_NoMesin" class="t02_jaminan_NoMesin"><?php echo $t02_jaminan->NoMesin->FldCaption() ?></span></th>
<?php } ?>

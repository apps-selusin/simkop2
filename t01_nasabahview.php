...
class ct01_nasabah_view extends ct01_nasabah {
	...
	function ExportData() {
		...
		// Export detail records (t02_jaminan)
		if (EW_EXPORT_DETAIL_RECORDS && in_array("t02_jaminan", explode(",", $this->getCurrentDetailTable()))) {
			global $t02_jaminan;
			if (!isset($t02_jaminan)) $t02_jaminan = new ct02_jaminan;
			$rsdetail = $t02_jaminan->LoadRs($t02_jaminan->GetDetailFilter()); // Load detail records
			if ($rsdetail && !$rsdetail->EOF) {
				...
				if ($this->Export <> "csv" || EW_EXPORT_DETAIL_RECORDS_FOR_CSV) {
					...
					$t02_jaminan->ExportDocument($Doc, $rsdetail, 1, $detailcnt);
				}
...
<?php if (!isset($t01_nasabah_view->Pager)) $t01_nasabah_view->Pager = new cPrevNextPager($t01_nasabah_view->StartRec, $t01_nasabah_view->DisplayRecs, $t01_nasabah_view->TotalRecs) ?>
...
<?php if ($t01_nasabah->Customer->Visible) { // Customer ?>
	<tr id="r_Customer">
		<td><span id="elh_t01_nasabah_Customer"><?php echo $t01_nasabah->Customer->FldCaption() ?></span></td>
...
<?php if ($t01_nasabah->NoTelpHp->Visible) { // NoTelpHp ?>
	<tr id="r_NoTelpHp">
		<td><span id="elh_t01_nasabah_NoTelpHp"><?php echo $t01_nasabah->NoTelpHp->FldCaption() ?></span></td>
...
<?php if ($t01_nasabah->AlamatPekerjaan->Visible) { // AlamatPekerjaan ?>
	<tr id="r_AlamatPekerjaan">
		<td><span id="elh_t01_nasabah_AlamatPekerjaan"><?php echo $t01_nasabah->AlamatPekerjaan->FldCaption() ?></span></td>
		<td data-name="AlamatPekerjaan"<?php echo $t01_nasabah->AlamatPekerjaan->CellAttributes() ?>>
<span id="el_t01_nasabah_AlamatPekerjaan">
<span<?php echo $t01_nasabah->AlamatPekerjaan->ViewAttributes() ?>>
<?php echo $t01_nasabah->AlamatPekerjaan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t01_nasabah->NoTelpPekerjaan->Visible) { // NoTelpPekerjaan ?>
	<tr id="r_NoTelpPekerjaan">
		<td><span id="elh_t01_nasabah_NoTelpPekerjaan"><?php echo $t01_nasabah->NoTelpPekerjaan->FldCaption() ?></span></td>
...
<?php echo $t01_nasabah->NoTelpPekerjaan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

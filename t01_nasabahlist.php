...
<?php if ($t01_nasabah->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t01_nasabah->SortUrl($t01_nasabah->id) ?>',2);"><div id="elh_t01_nasabah_id" class="t01_nasabah_id">
...
<?php if ($t01_nasabah->Customer->Visible) { // Customer ?>
	<?php if ($t01_nasabah->SortUrl($t01_nasabah->Customer) == "") { ?>
		<th data-name="Customer"><div id="elh_t01_nasabah_Customer" class="t01_nasabah_Customer"><div class="ewTableHeaderCaption"><?php echo $t01_nasabah->Customer->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="Customer"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t01_nasabah->SortUrl($t01_nasabah->Customer) ?>',2);"><div id="elh_t01_nasabah_Customer" class="t01_nasabah_Customer">
...
<?php if ($t01_nasabah->NoTelpHp->Visible) { // NoTelpHp ?>
	<?php if ($t01_nasabah->SortUrl($t01_nasabah->NoTelpHp) == "") { ?>
		<th data-name="NoTelpHp"><div id="elh_t01_nasabah_NoTelpHp" class="t01_nasabah_NoTelpHp"><div class="ewTableHeaderCaption"><?php echo $t01_nasabah->NoTelpHp->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="NoTelpHp"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t01_nasabah->SortUrl($t01_nasabah->NoTelpHp) ?>',2);"><div id="elh_t01_nasabah_NoTelpHp" class="t01_nasabah_NoTelpHp">

...
ft02_jaminanlist.Lists["x_nasabah_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Customer","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t01_nasabah"};
...
<?php if ($t02_jaminan->MerkType->Visible) { // MerkType ?>
	...
	<?php } else { ?>
		<th data-name="MerkType"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t02_jaminan->SortUrl($t02_jaminan->MerkType) ?>',2);"><div id="elh_t02_jaminan_MerkType" class="t02_jaminan_MerkType">
...
<?php if ($t02_jaminan->NoRangka->Visible) { // NoRangka ?>
	...
	<?php } else { ?>
		<th data-name="NoRangka"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t02_jaminan->SortUrl($t02_jaminan->NoRangka) ?>',2);"><div id="elh_t02_jaminan_NoRangka" class="t02_jaminan_NoRangka">
...
<?php if ($t02_jaminan->NoMesin->Visible) { // NoMesin ?>
	...
	<?php } else { ?>
		<th data-name="NoMesin"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t02_jaminan->SortUrl($t02_jaminan->NoMesin) ?>',2);"><div id="elh_t02_jaminan_NoMesin" class="t02_jaminan_NoMesin">
...
<?php if ($t02_jaminan->NoPol->Visible) { // NoPol ?>
	...
	<?php } else { ?>
		<th data-name="NoPol"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t02_jaminan->SortUrl($t02_jaminan->NoPol) ?>',2);"><div id="elh_t02_jaminan_NoPol" class="t02_jaminan_NoPol">
...
<?php if ($t02_jaminan->AtasNama->Visible) { // AtasNama ?>
	...
	<?php } else { ?>
		<th data-name="AtasNama"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t02_jaminan->SortUrl($t02_jaminan->AtasNama) ?>',2);"><div id="elh_t02_jaminan_AtasNama" class="t02_jaminan_AtasNama">

...
<?php if ($t06_pinjamantitipan->nasabah_id->Visible) { // nasabah_id ?>
	<tr id="r_nasabah_id">
		<td><span id="elh_t06_pinjamantitipan_nasabah_id"><?php echo $t06_pinjamantitipan->nasabah_id->FldCaption() ?></span></td>
...
<?php echo $t06_pinjamantitipan->nasabah_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>

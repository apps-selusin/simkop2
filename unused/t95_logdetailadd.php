...
$t95_logdetail_add = NULL; // Initialize page object first

class ct95_logdetail_add extends ct95_logdetail {
	...
	// Page object name
	var $PageObjName = 't95_logdetail_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("t95_logdetaillist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t95_logdetailview.php")
	...
	function LoadDefaultValues() {
		$this->logmaster_id->CurrentValue = NULL;
		$this->logmaster_id->OldValue = $this->logmaster_id->CurrentValue;
		...
		$this->date_->CurrentValue = NULL;
		$this->date_->OldValue = $this->date_->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// logmaster_id
		$this->logmaster_id->SetDbValueDef($rsnew, $this->logmaster_id->CurrentValue, 0, FALSE);
		...
		// date_
		$this->date_->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date_->CurrentValue, 0), ew_CurrentDate(), FALSE);
...
// Create page object
if (!isset($t95_logdetail_add)) $t95_logdetail_add = new ct95_logdetail_add();

// Page init
$t95_logdetail_add->Page_Init();

// Page main
$t95_logdetail_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t95_logdetail_add->Page_Render();
?>
...
var CurrentForm = ft95_logdetailadd = new ew_Form("ft95_logdetailadd", "add");

// Validate form
ft95_logdetailadd.Validate = function() {
...
ft95_logdetailadd.Form_CustomValidate = 
...
ft95_logdetailadd.ValidateRequired = true;
<?php } else { ?>
ft95_logdetailadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t95_logdetail_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t95_logdetail_add->ShowPageHeader(); ?>
<?php
$t95_logdetail_add->ShowMessage();
?>
<form name="ft95_logdetailadd" id="ft95_logdetailadd" class="<?php echo $t95_logdetail_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t95_logdetail_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t95_logdetail_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("ft95_logdetailadd", "x_date_", 0);
</script>
<?php } ?>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t95_logdetail_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft95_logdetailadd.Init();
</script>
<?php
$t95_logdetail_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t95_logdetail_add->Page_Terminate();
?>

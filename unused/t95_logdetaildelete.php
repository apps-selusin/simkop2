...
$t95_logdetail_delete = NULL; // Initialize page object first

class ct95_logdetail_delete extends ct95_logdetail {
	...
	// Page object name
	var $PageObjName = 't95_logdetail_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t95_logdetaillist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t95_logdetail class, t95_logdetailinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t95_logdetaillist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t95_logdetail_delete)) $t95_logdetail_delete = new ct95_logdetail_delete();

// Page init
$t95_logdetail_delete->Page_Init();

// Page main
$t95_logdetail_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t95_logdetail_delete->Page_Render();
?>
...
var CurrentForm = ft95_logdetaildelete = new ew_Form("ft95_logdetaildelete", "delete");

// Form_CustomValidate event
ft95_logdetaildelete.Form_CustomValidate = 
...
ft95_logdetaildelete.ValidateRequired = true;
<?php } else { ?>
ft95_logdetaildelete.ValidateRequired = false; 
<?php } ?>
...
<?php $t95_logdetail_delete->ShowPageHeader(); ?>
<?php
$t95_logdetail_delete->ShowMessage();
?>
<form name="ft95_logdetaildelete" id="ft95_logdetaildelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t95_logdetail_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t95_logdetail_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t95_logdetail">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t95_logdetail_delete->RecKeys as $key) { ?>
...
<?php if ($t95_logdetail->id->Visible) { // id ?>
		<th><span id="elh_t95_logdetail_id" class="t95_logdetail_id"><?php echo $t95_logdetail->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t95_logdetail->logmaster_id->Visible) { // logmaster_id ?>
		<th><span id="elh_t95_logdetail_logmaster_id" class="t95_logdetail_logmaster_id"><?php echo $t95_logdetail->logmaster_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t95_logdetail->index_->Visible) { // index_ ?>
		<th><span id="elh_t95_logdetail_index_" class="t95_logdetail_index_"><?php echo $t95_logdetail->index_->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t95_logdetail->subject->Visible) { // subject ?>
		<th><span id="elh_t95_logdetail_subject" class="t95_logdetail_subject"><?php echo $t95_logdetail->subject->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t95_logdetail->date_->Visible) { // date_ ?>
		<th><span id="elh_t95_logdetail_date_" class="t95_logdetail_date_"><?php echo $t95_logdetail->date_->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t95_logdetail->description->Visible) { // description ?>
		<th><span id="elh_t95_logdetail_description" class="t95_logdetail_description"><?php echo $t95_logdetail->description->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t95_logdetail_delete->RecCnt = 0;
$i = 0;
while (!$t95_logdetail_delete->Recordset->EOF) {
	$t95_logdetail_delete->RecCnt++;
	$t95_logdetail_delete->RowCnt++;

	// Set row properties
	$t95_logdetail->ResetAttrs();
	$t95_logdetail->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t95_logdetail_delete->LoadRowValues($t95_logdetail_delete->Recordset);

	// Render row
	$t95_logdetail_delete->RenderRow();
?>
	<tr<?php echo $t95_logdetail->RowAttributes() ?>>
<?php if ($t95_logdetail->id->Visible) { // id ?>
		<td<?php echo $t95_logdetail->id->CellAttributes() ?>>
<span id="el<?php echo $t95_logdetail_delete->RowCnt ?>_t95_logdetail_id" class="t95_logdetail_id">
...
<?php } ?>
<?php if ($t95_logdetail->logmaster_id->Visible) { // logmaster_id ?>
		<td<?php echo $t95_logdetail->logmaster_id->CellAttributes() ?>>
<span id="el<?php echo $t95_logdetail_delete->RowCnt ?>_t95_logdetail_logmaster_id" class="t95_logdetail_logmaster_id">
...
<?php } ?>
<?php if ($t95_logdetail->index_->Visible) { // index_ ?>
		<td<?php echo $t95_logdetail->index_->CellAttributes() ?>>
<span id="el<?php echo $t95_logdetail_delete->RowCnt ?>_t95_logdetail_index_" class="t95_logdetail_index_">
...
<?php } ?>
<?php if ($t95_logdetail->subject->Visible) { // subject ?>
		<td<?php echo $t95_logdetail->subject->CellAttributes() ?>>
<span id="el<?php echo $t95_logdetail_delete->RowCnt ?>_t95_logdetail_subject" class="t95_logdetail_subject">
...
<?php } ?>
<?php if ($t95_logdetail->date_->Visible) { // date_ ?>
		<td<?php echo $t95_logdetail->date_->CellAttributes() ?>>
<span id="el<?php echo $t95_logdetail_delete->RowCnt ?>_t95_logdetail_date_" class="t95_logdetail_date_">
...
<?php } ?>
<?php if ($t95_logdetail->description->Visible) { // description ?>
		<td<?php echo $t95_logdetail->description->CellAttributes() ?>>
<span id="el<?php echo $t95_logdetail_delete->RowCnt ?>_t95_logdetail_description" class="t95_logdetail_description">
...
<?php
	$t95_logdetail_delete->Recordset->MoveNext();
}
$t95_logdetail_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t95_logdetail_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft95_logdetaildelete.Init();
</script>
<?php
$t95_logdetail_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t95_logdetail_delete->Page_Terminate();
?>

...
//
// Table class for t93_logmain
//
class ct93_logmain extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't93_logmain';
		$this->TableName = 't93_logmain';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t93_logmain`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t93_logmain', 't93_logmain', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// index_
		$this->index_ = new cField('t93_logmain', 't93_logmain', 'x_index_', 'index_', '`index_`', '`index_`', 16, -1, FALSE, '`index_`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// subj_
		$this->subj_ = new cField('t93_logmain', 't93_logmain', 'x_subj_', 'subj_', '`subj_`', '`subj_`', 200, -1, FALSE, '`subj_`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "t94_logsub") {
			$sDetailUrl = $GLOBALS["t94_logsub"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "t93_logmainlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t93_logmain`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t93_logmainview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t93_logmainview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t93_logmainadd.php?" . $this->UrlParm($parm);
		else
			$url = "t93_logmainadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t93_logmainedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t93_logmainedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t93_logmainadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t93_logmainadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t93_logmaindelete.php", $this->UrlParm());
	}

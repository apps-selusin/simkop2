...
$t94_logsub_delete = NULL; // Initialize page object first

class ct94_logsub_delete extends ct94_logsub {
	...
	// Page object name
	var $PageObjName = 't94_logsub_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t94_logsublist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t94_logsub class, t94_logsubinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t94_logsublist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t94_logsub_delete)) $t94_logsub_delete = new ct94_logsub_delete();

// Page init
$t94_logsub_delete->Page_Init();

// Page main
$t94_logsub_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t94_logsub_delete->Page_Render();
?>
...
var CurrentForm = ft94_logsubdelete = new ew_Form("ft94_logsubdelete", "delete");

// Form_CustomValidate event
ft94_logsubdelete.Form_CustomValidate = 
...
ft94_logsubdelete.ValidateRequired = true;
<?php } else { ?>
ft94_logsubdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft94_logsubdelete.Lists["x_logmain_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_subj_","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t93_logmain"};
...
<?php $t94_logsub_delete->ShowPageHeader(); ?>
<?php
$t94_logsub_delete->ShowMessage();
?>
<form name="ft94_logsubdelete" id="ft94_logsubdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t94_logsub_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t94_logsub_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t94_logsub">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t94_logsub_delete->RecKeys as $key) { ?>
...
<?php if ($t94_logsub->logmain_id->Visible) { // logmain_id ?>
		<th><span id="elh_t94_logsub_logmain_id" class="t94_logsub_logmain_id"><?php echo $t94_logsub->logmain_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t94_logsub->index_->Visible) { // index_ ?>
		<th><span id="elh_t94_logsub_index_" class="t94_logsub_index_"><?php echo $t94_logsub->index_->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t94_logsub->subj_->Visible) { // subj_ ?>
		<th><span id="elh_t94_logsub_subj_" class="t94_logsub_subj_"><?php echo $t94_logsub->subj_->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t94_logsub_delete->RecCnt = 0;
$i = 0;
while (!$t94_logsub_delete->Recordset->EOF) {
	$t94_logsub_delete->RecCnt++;
	$t94_logsub_delete->RowCnt++;

	// Set row properties
	$t94_logsub->ResetAttrs();
	$t94_logsub->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t94_logsub_delete->LoadRowValues($t94_logsub_delete->Recordset);

	// Render row
	$t94_logsub_delete->RenderRow();
?>
	<tr<?php echo $t94_logsub->RowAttributes() ?>>
<?php if ($t94_logsub->logmain_id->Visible) { // logmain_id ?>
		<td<?php echo $t94_logsub->logmain_id->CellAttributes() ?>>
<span id="el<?php echo $t94_logsub_delete->RowCnt ?>_t94_logsub_logmain_id" class="t94_logsub_logmain_id">
...
<?php } ?>
<?php if ($t94_logsub->index_->Visible) { // index_ ?>
		<td<?php echo $t94_logsub->index_->CellAttributes() ?>>
<span id="el<?php echo $t94_logsub_delete->RowCnt ?>_t94_logsub_index_" class="t94_logsub_index_">
...
<?php } ?>
<?php if ($t94_logsub->subj_->Visible) { // subj_ ?>
		<td<?php echo $t94_logsub->subj_->CellAttributes() ?>>
<span id="el<?php echo $t94_logsub_delete->RowCnt ?>_t94_logsub_subj_" class="t94_logsub_subj_">
...
<?php
	$t94_logsub_delete->Recordset->MoveNext();
}
$t94_logsub_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t94_logsub_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft94_logsubdelete.Init();
</script>
<?php
$t94_logsub_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t94_logsub_delete->Page_Terminate();
?>

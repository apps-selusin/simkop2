...
$t94_logsub_grid = NULL; // Initialize page object first

class ct94_logsub_grid extends ct94_logsub {
	...
	// Page object name
	var $PageObjName = 't94_logsub_grid';

	// Grid form hidden field names
	var $FormName = 'ft94_logsubgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t94_logsub"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_logmain_id") && $objForm->HasValue("o_logmain_id") && $this->logmain_id->CurrentValue <> $this->logmain_id->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->logmain_id->setOldValue($objForm->GetValue("o_logmain_id"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t93_logmain") {
			$this->logmain_id->Visible = FALSE;
			if ($GLOBALS["t93_logmain"]->EventCancelled) $this->EventCancelled = TRUE;
		}

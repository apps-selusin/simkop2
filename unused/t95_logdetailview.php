...
$t95_logdetail_view = NULL; // Initialize page object first

class ct95_logdetail_view extends ct95_logdetail {
	...
	// Page object name
	var $PageObjName = 't95_logdetail_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t95_logdetaillist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t95_logdetaillist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t95_logdetail_view)) $t95_logdetail_view = new ct95_logdetail_view();

// Page init
$t95_logdetail_view->Page_Init();

// Page main
$t95_logdetail_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t95_logdetail_view->Page_Render();
?>
...
var CurrentForm = ft95_logdetailview = new ew_Form("ft95_logdetailview", "view");

// Form_CustomValidate event
ft95_logdetailview.Form_CustomValidate = 
...
ft95_logdetailview.ValidateRequired = true;
<?php } else { ?>
ft95_logdetailview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t95_logdetail->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t95_logdetail_view->IsModal) { ?>
<?php if ($t95_logdetail->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t95_logdetail_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t95_logdetail_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t95_logdetail_view->IsModal) { ?>
<?php if ($t95_logdetail->Export == "") { ?>
...
<?php } ?>
<?php $t95_logdetail_view->ShowPageHeader(); ?>
<?php
$t95_logdetail_view->ShowMessage();
?>
<?php if (!$t95_logdetail_view->IsModal) { ?>
<?php if ($t95_logdetail->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t95_logdetail_view->Pager)) $t95_logdetail_view->Pager = new cPrevNextPager($t95_logdetail_view->StartRec, $t95_logdetail_view->DisplayRecs, $t95_logdetail_view->TotalRecs) ?>
<?php if ($t95_logdetail_view->Pager->RecordCount > 0 && $t95_logdetail_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t95_logdetail_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t95_logdetail_view->PageUrl() ?>start=<?php echo $t95_logdetail_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t95_logdetail_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t95_logdetail_view->PageUrl() ?>start=<?php echo $t95_logdetail_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t95_logdetail_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t95_logdetail_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t95_logdetail_view->PageUrl() ?>start=<?php echo $t95_logdetail_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t95_logdetail_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t95_logdetail_view->PageUrl() ?>start=<?php echo $t95_logdetail_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t95_logdetail_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft95_logdetailview" id="ft95_logdetailview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t95_logdetail_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t95_logdetail_view->Token ?>">
<?php } ?>
...
<?php if ($t95_logdetail->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_t95_logdetail_id"><?php echo $t95_logdetail->id->FldCaption() ?></span></td>
...
<?php echo $t95_logdetail->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_logdetail->logmaster_id->Visible) { // logmaster_id ?>
	<tr id="r_logmaster_id">
		<td><span id="elh_t95_logdetail_logmaster_id"><?php echo $t95_logdetail->logmaster_id->FldCaption() ?></span></td>
...
<?php echo $t95_logdetail->logmaster_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_logdetail->index_->Visible) { // index_ ?>
	<tr id="r_index_">
		<td><span id="elh_t95_logdetail_index_"><?php echo $t95_logdetail->index_->FldCaption() ?></span></td>
...
<?php echo $t95_logdetail->index_->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_logdetail->subject->Visible) { // subject ?>
	<tr id="r_subject">
		<td><span id="elh_t95_logdetail_subject"><?php echo $t95_logdetail->subject->FldCaption() ?></span></td>
...
<?php echo $t95_logdetail->subject->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_logdetail->date_->Visible) { // date_ ?>
	<tr id="r_date_">
		<td><span id="elh_t95_logdetail_date_"><?php echo $t95_logdetail->date_->FldCaption() ?></span></td>
...
<?php echo $t95_logdetail->date_->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t95_logdetail->description->Visible) { // description ?>
	<tr id="r_description">
		<td><span id="elh_t95_logdetail_description"><?php echo $t95_logdetail->description->FldCaption() ?></span></td>
...
<?php echo $t95_logdetail->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t95_logdetail->Export == "") { ?>
<script type="text/javascript">
ft95_logdetailview.Init();
</script>
<?php } ?>
<?php
$t95_logdetail_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($t95_logdetail->Export == "") { ?>
...
<?php
$t95_logdetail_view->Page_Terminate();
?>

...
<?php } ?>
<link rel="shortcut icon" type="image/png" href="<?php echo ew_ConvertFullUrl("SIM Koperasi") ?>"><link rel="icon" type="image/png" href="<?php echo ew_ConvertFullUrl("SIM Koperasi") ?>">

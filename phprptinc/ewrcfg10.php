...
define("EWR_PROJECT_ID", "{1F354293-F296-4B13-80A8-520A61B09C85}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "simkop2_prj", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_simkop2", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", '6vRHZ12wrFg08rIK', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/simkop2_prj.css", TRUE); // Project stylesheet file name
...
define("EWR_CASE_SENSITIVE_PASSWORD", TRUE, TRUE); // Case-sensitive password
...
define("EWR_TABLE_PREFIX", "{1F354293-F296-4B13-80A8-520A61B09C85}", TRUE);

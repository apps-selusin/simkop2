...
$RootMenu->AddMenuItem(9, "mi_t98_userlevelpermissions", $Language->MenuPhrase("9", "MenuText"), "t98_userlevelpermissionslist.php", 12, "", (@$_SESSION[EW_SESSION_USER_LEVEL] & EW_ALLOW_ADMIN) == EW_ALLOW_ADMIN, FALSE, FALSE);

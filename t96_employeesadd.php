...
// Multi-Page
ft96_employeesadd.MultiPage = new ew_MultiPage("ft96_employeesadd");
...
<div class="panel-group" id="t96_employees_add">
	<div class="panel panel-default<?php echo $t96_employees_add->MultiPages->PageStyle("1") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#t96_employees_add" href="#tab_t96_employees1"><?php echo $t96_employees->PageCaption(1) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $t96_employees_add->MultiPages->PageStyle("1") ?>" id="tab_t96_employees1">
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $t96_employees_add->MultiPages->PageStyle("2") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#t96_employees_add" href="#tab_t96_employees2"><?php echo $t96_employees->PageCaption(2) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $t96_employees_add->MultiPages->PageStyle("2") ?>" id="tab_t96_employees2">
			<div class="panel-body">
<div>
...
<?php } ?>
	...
	<div class="panel panel-default<?php echo $t96_employees_add->MultiPages->PageStyle("3") ?>">
		<div class="panel-heading">
			<h4 class="panel-title">
				<a class="panel-toggle" data-toggle="collapse" data-parent="#t96_employees_add" href="#tab_t96_employees3"><?php echo $t96_employees->PageCaption(3) ?></a>
			</h4>
		</div>
		<div class="panel-collapse collapse<?php echo $t96_employees_add->MultiPages->PageStyle("3") ?>" id="tab_t96_employees3">
			<div class="panel-body">
<div>
